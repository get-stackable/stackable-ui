...
class FileInput extends React.Component {
  ...
  //   uploadFile = event => {
  //     const metaContext = { type: 'userUpload' };
  //     const uploader = new Slingshot.Upload('imageUploads', metaContext);
  //     const file = event.target.files[0];
  //     this.setState({ isLoading: true }); // show loading

  //     // progress bar
  //     const computation = Tracker.autorun(() => {
  //       const progress = Math.ceil(uploader.progress() * 100);
    ...
    return (
      <div>
        ...
        <button
          ...
          // onClick={this.triggerInput.bind(this)}
          style={{ margin: '10px 0' }}
        >
