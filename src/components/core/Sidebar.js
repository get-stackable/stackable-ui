    ...
    return (
      <div className="ui left vertical labeled icon menu">
        <a className="item" href="{FlowRouter.path('home')}" style={{ paddingTop: '3em' }}>
          <img src="/images/icon-dashboard.png" className="icon" style={{ width: '30px', height: '30px' }} alt="dashboard" />
                  Dashboard
        </a>
        ...
        <a className="item" href="{FlowRouter.path('containersList', {appId: this.data.activeApp.id})}">
          <img src="/images/icon-container.png" className="icon" style={{ width: '30px', height: '30px' }} alt="container-icon" />
                  Containers
        </a>
        ...
        <a className="item" href="{FlowRouter.path('settings')}">
          <img src="/images/icon-settings.png" className="icon" style={{ width: '30px', height: '32px' }} alt="setting-icon" />
                  Settings
        </a>
