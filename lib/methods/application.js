...
Meteor.methods({
    'app.create': function (doc) {
        ...
        doc.publicKey = Random.id(5);
        doc.privateKey = Random.id(5);
    ...
    'app.generateKey': function (id) {
        ...
        app.set({
            publicKey: Random.id(5),
            privateKey: Random.id(5)
        });
    ...
    'app.clone': function (id, doc) {
        ...
        appCopy.publicKey = Random.id(5);
        appCopy.privateKey = Random.id(5);
        appCopy.save();
